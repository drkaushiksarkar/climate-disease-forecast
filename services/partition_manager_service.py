"""Service layer for partition_manager operations."""
import logging
...
class PartitionManagerService:
    """Service for partition_manager domain operations."""
    ...
    async def fetch(self, query: Dict[str, Any]) -> PartitionManagerResult:
        ...
        try:
            ...
            return PartitionManagerResult(success=True, data=data, duration_ms=duration)
        except Exception as e:
            logger.error("Fetch failed: %s", e)
            return PartitionManagerResult(success=False, error=str(e))
