...
class NotificationService:
    """Service for notification domain operations."""
    ...
    async def fetch(self, query: Dict[str, Any]) -> NotificationResult:
        ...
        try:
            ...
            return NotificationResult(success=True, data=data, duration_ms=duration)
