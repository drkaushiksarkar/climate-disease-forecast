"""Service layer for ingestion_pipeline operations."""
import logging
...
class IngestionPipelineService:
    """Service for ingestion_pipeline domain operations."""
    ...
    async def fetch(self, query: Dict[str, Any]) -> IngestionPipelineResult:
        ...
        try:
            ...
            return IngestionPipelineResult(success=True, data=data, duration_ms=duration)
        except Exception as e:
            logger.error("Fetch failed: %s", e)
            return IngestionPipelineResult(success=False, error=str(e))
