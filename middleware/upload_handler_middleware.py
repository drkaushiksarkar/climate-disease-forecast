"""Middleware for upload_handler request processing."""
import logging
import time
...
class UploadHandlerMiddleware:
    """Middleware that handles upload_handler processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("upload_handler middleware error: %s", e)
                raise
            finally:
