"""Middleware for batch_processor request processing."""
import logging
import time
...
class BatchProcessorMiddleware:
    """Middleware that handles batch_processor processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("batch_processor middleware error: %s", e)
                raise
            finally:
