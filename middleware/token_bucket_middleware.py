"""Middleware for token_bucket request processing."""
import logging
import time
...
class TokenBucketMiddleware:
    """Middleware that handles token_bucket processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("token_bucket middleware error: %s", e)
                raise
            finally:
