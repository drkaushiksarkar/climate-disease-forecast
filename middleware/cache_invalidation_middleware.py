"""Middleware for cache_invalidation request processing."""
import logging
import time
...
class CacheInvalidationMiddleware:
    """Middleware that handles cache_invalidation processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("cache_invalidation middleware error: %s", e)
                raise
            finally:
