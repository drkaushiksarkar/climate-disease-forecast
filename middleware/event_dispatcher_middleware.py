"""Middleware for event_dispatcher request processing."""
import logging
import time
...
class EventDispatcherMiddleware:
    """Middleware that handles event_dispatcher processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("event_dispatcher middleware error: %s", e)
                raise
            finally:
