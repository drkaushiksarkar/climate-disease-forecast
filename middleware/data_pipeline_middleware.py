"""Middleware for data_pipeline request processing."""
import logging
import time
...
class DataPipelineMiddleware:
    """Middleware that handles data_pipeline processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("data_pipeline middleware error: %s", e)
                raise
            finally:
