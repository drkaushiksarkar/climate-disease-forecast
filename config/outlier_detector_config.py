"""Configuration for outlier_detector subsystem."""
import os
...
class OutlierDetectorConfig:
    """Configuration parameters for outlier_detector."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "OUTLIER_DETECTOR") -> "OutlierDetectorConfig":
        return cls(
