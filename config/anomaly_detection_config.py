"""Configuration for anomaly_detection subsystem."""
import os
...
class AnomalyDetectionConfig:
    """Configuration parameters for anomaly_detection."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "ANOMALY_DETECTION") -> "AnomalyDetectionConfig":
        return cls(
