"""Configuration for latency_monitor subsystem."""
import os
...
class LatencyMonitorConfig:
    """Configuration parameters for latency_monitor."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "LATENCY_MONITOR") -> "LatencyMonitorConfig":
        return cls(
