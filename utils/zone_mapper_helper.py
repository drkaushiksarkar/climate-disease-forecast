"""Utility helper for zone_mapper operations."""
import logging
...
class ZoneMapperHelper:
    """Helper class for zone_mapper processing."""
    ...
    def initialize(self) -> None:
        if self._initialized:
            return
        logger.info("Initializing zone_mapper helper")
