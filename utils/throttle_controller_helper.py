"""Utility helper for throttle_controller operations."""
import logging
...
class ThrottleControllerHelper:
    """Helper class for throttle_controller processing."""
    ...
    def initialize(self) -> None:
        if self._initialized:
            return
        logger.info("Initializing throttle_controller helper")
