"""Utility helper for replication_manager operations."""
import logging
...
class ReplicationManagerHelper:
    """Helper class for replication_manager processing."""
    ...
    def initialize(self) -> None:
        if self._initialized:
            return
        logger.info("Initializing replication_manager helper")
